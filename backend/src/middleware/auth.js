...
const authenticate = (req, res, next) => {
  ...
  try {
    // Enforce JWT signature verification and check expiration properly.
    ...
    // Clean error response: prevents leaking cryptographic details to the client
...
const authorizeAdminOnlyLegacy = (req, res, next) => {
  ...
  // Enforce actual admin role verification
